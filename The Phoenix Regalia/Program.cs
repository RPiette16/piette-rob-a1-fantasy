        ...
        else if (path == "Woods")
        {
            ...
            else if (tunnel == "Right")
            {
                ...
                else if (outcome == "Two")
                {
                    ...
                    Console.Write("\n\nYou return to Locksar town and are greeted by the whole town, because you saved them from the Phoenix and Mr Snyde they offer you his wealth and his home!");
